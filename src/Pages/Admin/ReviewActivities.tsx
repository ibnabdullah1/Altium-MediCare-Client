...
import Rating from "react-rating"; // Ensure this package is installed
import { useGetAllShopReviewQuery } from "../../Redux/features/shop/shopApi";
import LoaderSpinner from "../../Shared/LoaderSpinner";

const ReviewActivities = () => {
  const { data, error, isLoading } = useGetAllShopReviewQuery(undefined);
